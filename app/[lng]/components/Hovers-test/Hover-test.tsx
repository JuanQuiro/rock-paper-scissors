...
export const Hover1 = () => {
  ...
  const [mouseazul, setMouseazul] = useState(false);
  const [mouseazulmarco, setMouseazulmarco] = useState(false);
  const [mouseazulfondo, setMouseazulfondo] = useState(false);
  const [mouseazulobjeto, setMouseazulobjeto] = useState(false);
    ...
    <div className="flex flex-col justify-center items-center">
      ...
      >
        ...
        <path
          ...
          onMouseEnter={() => {
            if (mouse === false) {
              console.log("MOUSE ADMIN - ENTRO AZUL");
              setMouse(true)
            }
            if (mouseazulmarco === false) {
              setMouseazulmarco(true)
              console.log("Mouse entro en marco azul");
            }
            else {
              setMouseazulmarco(false)
              console.log("Mouse salio en marco azul");
            }
          }}

          onMouseLeave={() => {
            if (mouse === true && mouseazulmarco === false)  {
              console.log("MOUSE ADMIN - SALIO AZUL");
              setMouse(false)
            }
          }}
        />
        <path
          ...
          onMouseEnter={() => {
            console.log("Mouse entro a fondo azul");
          }}
          onMouseLeave={() => {
            console.log("Mouse salio de fondo azul");
          }}
        />
        <path
